...
bool my_robot_interfaces__msg__target_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_robot_interfaces.msg._target_list.TargetList", full_classname_dest, 47) == 0);
  }
  my_robot_interfaces__msg__TargetList * ros_message = _ros_message;
  {  // name
...
PyObject * my_robot_interfaces__msg__target_list__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_robot_interfaces.msg._target_list");
