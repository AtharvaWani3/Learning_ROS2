        ...
        try:
            self.declare_parameters(
                ...
                parameters=[
                    ...
                    ('control_gain', rclpy.Parameter.Type.DOUBLE),
                    ('softening_gain', rclpy.Parameter.Type.DOUBLE),
                    ('yawrate_gain', rclpy.Parameter.Type.DOUBLE),
                    ('steering_limits', rclpy.Parameter.Type.DOUBLE),
                    ('centreofgravity_to_frontaxle', rclpy.Parameter.Type.DOUBLE)
                ]
            )
